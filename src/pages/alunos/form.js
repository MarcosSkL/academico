                ...
                <Col>
                    <Form>
                        <Form.Group className="mb-3" controlId="Nome">
                            ...
                            <Form.Control type="text" placeholder="Nome" {...register('nome', cursoValidator.aluno.nome)} />
                            {
                                errors.nome &&
                        ...
                        <Form.Group className="mb-3" controlId="Cpf">
                            ...
                            <Form.Control type="text" placeholder="CPF" mask="999.999.999-99" {...register('cpf', cursoValidator.aluno.cpf)} onChange={MaskName} />
                            {
                                errors.cpf &&
                        ...
                        <Form.Group className="mb-3" controlId="Matricula">
                            ...
                            <Form.Control type="number" placeholder="Matricula" {...register('matricula', cursoValidator.aluno.matricula)} />
                            {
                                errors.matricula &&
                        ...
                        <Form.Group className="mb-3" controlId="Email">
                            ...
                            <Form.Control type="email" placeholder="E-mail" {...register('email', cursoValidator.aluno.email)} />
                            {
                                errors.email &&
                        ...
                        <Form.Group className="mb-3" controlId="Telefone">
                            ...
                            <Form.Control type="text" placeholder="Telefone" mask="(99) 9999-9999, (99) 99999-9999" {...register('telefone', cursoValidator.aluno.telefone)} onChange={MaskName} />
                            {
                                errors.telefone &&
                        ...
                        <Form.Group className="mb-3" controlId="Logradouro">
                            ...
                            <Form.Control type="text" placeholder="Logradouro" {...register('logradouro', cursoValidator.aluno.logradouro)} />
                            {
                                errors.logradouro &&
                        ...
                        <Form.Group className="mb-3" controlId="Complemento">
                            ...
                            <Form.Control type="text" placeholder="Complemento" {...register('complemento', cursoValidator.aluno.complemento)} />
                            {
                                errors.complemento &&
                        ...
                        <Form.Group className="mb-3" controlId="Numero">
                            ...
                            <Form.Control type="text" placeholder="Numero" {...register('numero', cursoValidator.aluno.numero)} />
                            {
                                errors.numero &&
                        ...
                        <Form.Group className="mb-3" controlId="Bairro">
                            ...
                            <Form.Control type="text" placeholder="Bairro" {...register('bairro', cursoValidator.aluno.bairro)} />
                            {
                                errors.bairro &&
